      ...
      <nav>
        ...
        if($_SESSION['role_id'] > 0 ){ ?>
          <li class="nav-item dropdown">
            <a class="nav-link text-dark dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-expanded="false">Hi <?= $user['name']; ?></a>
            <div class="dropdown-menu">
              <a class="dropdown-item btn-sm" href="<?= base_url('auth/logout'); ?>">Logout</a>
            </div>
  </li>
        <?php }else{ ?>
        <li class="nav-item">
              ...
              <div class="col-4 mb-3">
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <a href="<?= base_url('kedai/detail/'); ?><?= $item['id']; ?>" class="text-dark my-2 btn btn-outline-secondary btn-block btn-sm">Details</a>
                  </div>
                </div>
              </div>
            <?php endforeach; ?>

    ...
    <div class="branding d-flex align-items-cente">
      ...
      <div class="container position-relative d-flex align-items-center justify-content-between">
        ...
        <nav id="navmenu" class="navmenu">
          <ul>
            <li>
              <a href="<?= base_url('home'); ?>" class="active">Home<br /></a>
            </li>
            <li>
              <a href="<?= base_url('home/kedai'); ?>" class="active">Kedai<br /></a>
            </li>
  ...
  <main class="main">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="service-item  position-relative">
              <a href="<?= base_url('home/filter_by_category/'). $k['id']; ?>" class="stretched-link">
    ...
    <section id="portfolio" class="portfolio section">
          ...
          <?php foreach ($kedai as $item ) : ?>
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-app">
              ...
              <div class="portfolio-info">
                ...
                <a href="<?= base_url('home/detail_kedai/'); ?><?= $item->id; ?>" title="More Details" class="details-link"><i class="bi bi-link-45deg"></i></a>
              </div>
      ...
      <?php if (count($kedai) >= $limit): ?>
          ...
          <a class="text-dark p-2 fs-4" href="<?php echo base_url('home/kedai'); ?>">Lihat Selengkapnya...</a>
          </div>
